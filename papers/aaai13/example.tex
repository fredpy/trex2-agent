...
\begin{figure}[!t]
  ...
  \caption{\small{(\ref{fig:ex:graph}) illustrates the domain along
      ...
      $8$am and the mission is expected to complete by
      $8$pm with the Science goal --- marked with thick borders --- 
      to sample {\em Vent 1} and the operational goal to be beack at
      the surface for recovery by the ned of the mission.}}
\label{fig:Example}
\end{figure}
