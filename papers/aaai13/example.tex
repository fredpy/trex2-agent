...
\begin{figure}[!t]
  ...
  \hfill \subfloat[\small The initial state]{\label{fig:ex:init}\includegraphics[width=0.49\columnwidth]{figs/example_initial}}
  \caption{\small{(\ref{fig:ex:graph}) illustrates the domain along
      ...
      $8$am and the mission is expected to complete by $8$pm with the
      Science goal --- marked with thick borders --- to sample {\em
        Vent 2} and the operational goal to be beack at the surface
      for recovery by the ned of the mission.}}
\label{fig:Example}
\end{figure}
...
{\em Deferring} the actions is not acceptable since it results in the
