...
Still, including \kcomment{including where and what?} such information
...
that is then prohibiting the agent from accepting goals in the morning
\kcomment{substitute morning with some actual time}. Typically the
