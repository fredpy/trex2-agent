...
\begin{figure}
\includegraphics[width=0.5\textwidth]{figs/example1.jpg}
\caption{ Map of all the locations for the agent to
  visit\fcomment{Need extra bubble for the Need to be home at 8pm}}
\label{fig:Example}
\end{figure}
...
\begin{figure}
  \centering
  \subfloat[Initial
  problem]{\label{fig:ex:init}\includegraphics[width=0.7\columnwidth]{figs/example_initial}}
  \\
  \subfloat[Plan
  solution]{\label{fig:ex:plan}\includegraphics[width=0.8\columnwidth]{figs/example_plan}}
  \caption{Graphical views of the initial problem (\ref{fig:ex:init})
    for the example in Fig. \ref{fig:Example} and a flexible plan
    solution (\ref{fig:ex:plan}) along with its temporal constraints.}
\end{figure}
