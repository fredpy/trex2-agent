...
left to identify and execute an alternate strategy. An early dispatch
policy therefore, proved to be the most efficient approach for the
robot to robustly execute its plan when the set of goals for the
mission are fully instantiated.
