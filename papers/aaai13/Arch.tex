...
Our work is complementary to much of the above.  The focus of our is
not on the observation of events during execution but rather on the
possibility of \emph{new objectives} arising at any time, and to avoid
doing actions that are not ``urgent'' to preserve the context for
those objectives.  Similarly, temporal preference specification during
...
$X$ \cite{py10dup}. \kcomment{define observations/timepoints; better
