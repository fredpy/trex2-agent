...
\begin{figure}
  \centering
\subfloat[Domain
illustration]{\label{fig:ex:graph}\includegraphics[width=0.51\columnwidth]{figs/auv_example}}
\hfill
\subfloat[Initial problem]{\label{fig:ex:init}\includegraphics[width=0.47\columnwidth]{figs/example_initial}}
\caption{A description of our hydrotermal vent problem with an
  ...
  our AUV is initially at {\em Surface} at 8am, he wants to survey
  {\em vent 2} which is active
  before noon and needs to be back 
  at {\em Surface} before the end of its mission 
  at 8pm (noted 20:00 here).}
\label{fig:Example}
\end{figure}
