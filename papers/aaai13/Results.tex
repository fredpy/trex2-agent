...
\begin{figure}
  ...
  \caption{\small Our algorithm solution for the plan from
    Fig. \ref{fig:ex:plan}. Solid lines indicates conditions and 
    dashed lines indicates effects. Pentagons indicate {\em urgent} goals, 
    stars indicate tokens that were deduced  as {\em proactive} by our
    algorithm.}
  \label{fig:ex:mixed1}
\end{figure}
