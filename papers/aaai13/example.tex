...
such as a hydrothermal vent depicted in Fig. \ref{fig:ex:axial}.  The
...
\begin{figure}[!t]
  ...
  \caption{\small{\ref{fig:ex:axial} shows bathymetry of actual vent
      sites off the coast of Oregon. (\ref{fig:ex:graph}) illustrates
      the domain along with the initial partial plan for this problem
...
goals, while \emph{proactive} execution leading to inefficiency. 
