...
durative actions and resources the focus of our work here
\cite{lemai04}.
...
To avoid procrastination the solution selected has often been to start
actions as early as possible while ensuring that it does not impact
the plan brittleness. This choice is lead by the intuition that by
...
distinction for each action by tracing the causal relations with goals
within the current plan.  This allow us to determine the best strategy
based on the nature of the goals this action contribute to.
